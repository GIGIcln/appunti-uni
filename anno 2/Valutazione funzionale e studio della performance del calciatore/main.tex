...
\part{Basi e strumenti della valutazione funzionale}

\input{capitoli/01_il_sistema_neuromuscolare}
\input{capitoli/02_presupposti_scientifici_valutazione_funzionale}
\input{capitoli/03_validita_strumenti_di_misura}
\input{capitoli/04_dinamometria_isoinerziale}
\input{capitoli/05_allenamento_potenza_muscolare}
\input{capitoli/06_elettromiografia_di_superficie}
\input{capitoli/07_stimolo_vibratorio_e_prestazione}
\input{capitoli/08_valutazione_sistemi_energetici}

\part{Il futsal}

\input{capitoli/09_introduzione_al_futsal}
\input{capitoli/10_tecnica_tattica_futsal}
\input{capitoli/11_match_analysis}
\input{capitoli/12_la_capacita_di_carico}
\input{capitoli/13_profilo_giocatore_futsal}
\input{capitoli/14_valutazione_metabolismo_anaerobico}
\input{capitoli/15_valutazione_metabolismo_aerobico}

\part{Il calcio}

\input{capitoli/16_storia_preparazione_fisica_calcio}
\input{capitoli/17_modello_prestativo_calcio}
\input{capitoli/18_test_valutazione_funzionale_calcio}
\input{capitoli/19_cardiofrequenzimetri_controllo_allenamento}
\input{capitoli/20_repeated_sprint_ability_calcio}
\input{capitoli/21_infortuni_nel_calcio}
\input{capitoli/22_programmazione_preparazione_fisica_calcio}
