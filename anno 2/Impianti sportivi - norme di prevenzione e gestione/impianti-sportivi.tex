...
\title{Dispense di \underline{Impianti sportivi}\\ \underline{norme di prevenzione e gestione}}
\author{}                    % resta VUOTO: niente nomi di docenti (vedi CONVENZIONI.md §4)
\date{A.A. 2025/2026}
...
\input{capitoli/01_definizione_di_impianto_sportivo_e_servizio_pubblico}
\input{capitoli/02_concessione_e_appalto_di_servizi_pubblici}
\input{capitoli/03_la_rilevanza_economica_degli_impianti}
\input{capitoli/04_le_leggi_regionali_in_materia_di_impiantistica}
\input{capitoli/05_le_forme_di_partenariato_pubblico_privato}

\end{document}

% =============================================================================
% PROMEMORIA STILE SCHEMATICO (fonte autorevole: CONVENZIONI.md, "Come si scrive")
% =============================================================================
