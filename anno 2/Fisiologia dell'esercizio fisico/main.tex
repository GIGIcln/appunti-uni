...
% --- Metadati ---
\title{Dispense di \underline{Fisiologia dell'esercizio fisico}}
\author{}
\date{A.A. 2025/2026}
...
\input{capitoli/01_omeostasi}
\input{capitoli/02_eccitabilita_cellulare}
\input{capitoli/03_trasmissione_sinaptica}
\input{capitoli/04_organizzazione_sistema_nervoso}
\input{capitoli/05_sistema_nervoso_sensoriale}
