...
\[
\begin{aligned}
\text{glicolisi} &\rightarrow \text{fosforilazione ossidativa} \rightarrow ATP \\
&\rightarrow \left\{\text{sintesi proteine, energia meccanica, trasporto attivo, calore}\right\} \\
&\rightarrow ADP \rightarrow ATP \quad (\text{il ciclo si richiude})
\end{aligned}
\]
