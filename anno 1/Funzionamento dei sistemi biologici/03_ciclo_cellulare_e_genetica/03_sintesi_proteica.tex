...
\end{itemize}
Il codone di inizio AUG codifica per la metionina; i codoni UAA, UAG, UGA non codificano per alcun aminoacido e fungono da codoni di terminazione.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{|c|X|X|X|X|c|}
    \hline
    \textbf{1\textsuperscript{a} base} & \textbf{U} & \textbf{C} & \textbf{A} & \textbf{G} & \textbf{3\textsuperscript{a} base} \\
    \hline
    \multirow{4}{*}{\textbf{U}} & Phe & Ser & Tyr & Cys & U \\
     & Phe & Ser & Tyr & Cys & C \\
     & Leu & Ser & STOP & STOP & A \\
     & Leu & Ser & STOP & Trp & G \\
    \hline
    \multirow{4}{*}{\textbf{C}} & Leu & Pro & His & Arg & U \\
     & Leu & Pro & His & Arg & C \\
     & Leu & Pro & Gln & Arg & A \\
     & Leu & Pro & Gln & Arg & G \\
    \hline
    \multirow{4}{*}{\textbf{A}} & Ile & Thr & Asn & Ser & U \\
     & Ile & Thr & Asn & Ser & C \\
     & Ile & Thr & Lys & Arg & A \\
     & Met & Thr & Lys & Arg & G \\
    \hline
    \multirow{4}{*}{\textbf{G}} & Val & Ala & Asp & Gly & U \\
     & Val & Ala & Asp & Gly & C \\
     & Val & Ala & Glu & Gly & A \\
     & Val & Ala & Glu & Gly & G \\
    \hline
