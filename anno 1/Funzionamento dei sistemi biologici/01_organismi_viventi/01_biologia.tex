...
\textbf{Biologia}: dal greco \textit{bíos} (``vita'') e \textit{lógos} (``studio'') $\rightarrow$ studio della vita.

Tre concetti unificanti:
\begin{itemize}
...
\[
\text{atomo} \rightarrow \text{molecola} \rightarrow \text{macromolecola} \rightarrow \text{procariote} \rightarrow \text{organello} \rightarrow
\]
\[
\text{cellula eucariote} \rightarrow \text{tessuto} \rightarrow \text{organo} \rightarrow \text{apparato} \rightarrow \text{organismo} \rightarrow
\]
\[
\text{popolazione} \rightarrow \text{comunità} \rightarrow \text{ecosistema} \rightarrow \text{biosfera}.
\]
